    ...
    >
      <div className="absolute inset-0 bg-gradient-to-r from-white/90 to-transparent flex items-center px-4 sm:px-10 md:px-20">
        <div className="max-w-full sm:max-w-md md:max-w-xl">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-snug sm:leading-tight md:leading-tight mb-3 sm:mb-4">
            LUXURY VILLA<br />MINUTES<br />FROM THE BAY
          </h1>
          <p className="text-blue-500 text-lg sm:text-xl md:text-2xl font-semibold mb-3 sm:mb-4">
            $3,500,000
          </p>
          ...
          <Link to="/sales">
            <button className="border-2 border-black text-black px-4 sm:px-6 py-2 sm:py-3 rounded-2xl hover:bg-black hover:text-white transition text-sm sm:text-base md:text-lg">
              READ MORE
            </button>
          </Link>
        </div>
