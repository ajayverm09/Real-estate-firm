  ...
  return (
    <div className="bg-white py-12 sm:py-16 px-4 sm:px-6 lg:px-12">
      <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-gray-100 rounded-2xl p-6 sm:p-8 flex items-center justify-center">
        ...
        <div className="bg-gray-100 p-6 sm:p-8 rounded-2xl flex flex-col items-start justify-center">
